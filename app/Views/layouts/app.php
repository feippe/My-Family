...
<title><?= \App\Core\View::e($pgTitle) ?> — Familia</title>
...
<div class="layout">
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="logo">
        ...
        <span class="logo-text">Familia</span>
      </div>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="<?= $appUrl ?>/settings/ext-calendars" class="nav-item <?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'ext-calendar') ? 'active' : '' ?>">
        ...
        <span>Calendarios externos</span>
      </a>
    </nav>
  ...
  <nav class="bottom-nav" aria-label="Navegación principal">
    <a href="<?= $appUrl ?>/calendar" class="bn-item <?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'calendar') ? 'active' : '' ?>" aria-label="Calendario">
    ...
    <a href="<?= $appUrl ?>/group" class="bn-item <?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'group') ? 'active' : '' ?>" aria-label="Familia">
    ...
    <a href="<?= $appUrl ?>/settings" class="bn-item <?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'settings') ? 'active' : '' ?>" aria-label="Ajustes">
